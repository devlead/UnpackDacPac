...
Setup(
    static context => {
        ...
        var projectPath = projectRoot.CombineWithFilePath("UnpackDacPac/UnpackDacPac.csproj");
        ...
        return new BuildData(
            ...
            new DotNetMSBuildSettings()
                ...
                .WithProperty("PackageTags", "sql;dacpac;dac;dacfx")
                .WithProperty("PackageDescription", "Unpack DAC Package .NET Tool - Extracts dacpac and generates deployment script to target folder without need for actual database running.")
                .WithProperty("RepositoryUrl", "https://github.com/devlead/UnpackDacPac.git")
