namespace UnpackDacPac.Commands.Validation;
...
#pragma warning restore CS8625 // Cannot convert null literal to non-nullable reference type.
    ...
    public override ValidationResult Validate(CommandParameterContext context) => context.Value switch
    {
        ...
        DirectoryPath directoryPath when directoryPath.GetParent() is DirectoryPath parent && Directory.Exists(parent.FullPath)
            => ValidationResult.Success(),
